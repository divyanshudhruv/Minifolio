...
> [!IMPORTANT]
> 🎉 Special **`THANKS & SHOUTOUT`** to **[@loeclos](https://github.com/loeclos)** for their **`valuable`** ⭐ **`contributions`** and **`support`** in bringing this project to 🌌 **`Next.js`**! Your help made this transition 🎡 **`smooth`** and **`efficient`**, and we couldn’t have done it without 🙌 `you`.
